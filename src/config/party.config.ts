  ...
  slides: {
    ...
    items: [
      ...
      },
      {
        ...
        caption: "2007. Cleared the Grand Canyon on a scooter.",
        alt: "2007. Cleared the Grand Canyon on a scooter.",
      },
      {
        src: "/img/slides/knights.jpeg",
        caption: "2011. Cut down the mightiest tree in the forest... wiiiith... a HERRING!",
